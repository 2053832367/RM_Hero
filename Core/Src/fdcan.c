...
/* USER CODE BEGIN 0 */
uint32_t check_fdcan1_RAM_Offset;    /* fdcan1RAM^J§³(fdcan2MessageRAMOffset) (check_fdcan1_RAM_Offset = hfdcan1.msgRam.EndAddress - SRAMCAN_BASE)*/
uint32_t check_fdcan2_RAM_Offset;    /* fdcan1fdcan2RAM^J§³(fdcan3MessageRAMOffset) (check_fdcan2_RAM_Offset = hfdcan2.msgRam.EndAddress - SRAMCAN_BASE)*/
uint32_t check_fdcan3_RAM_Offset;    /* fdcan1fdcan2fdcan3RAM^J§³ (check_fdcan3_RAM_Offset = hfdcan3.msgRam.EndAddress - SRAMCAN_BASE)*/
/* USER CODE END 0 */
