...
typedef struct {
    ...
    uint8_t nodeId;                      //!<@brief 驱动器节点
		...
		uint32_t axisError;                  //!<@brief 驱动异常码
		uint8_t  Axis_State;								 //!<@brief 驱动器状态
	
    struct {                                  
        uint8_t motorErrorFlag;          //!<@brief 电机异常位
        uint8_t encoderErrorFlag;        //!<@brief 编码器异常位
        uint8_t controllerErrorFlag;     //!<@brief 控制器异常位
			  uint8_t systemErrorFlag;				 //!<@brief 系统异常位
    } Error_Flags;                       //!<@brief 异常标志位
		uint8_t     Life;                    //!<@brief 周期消息的生命值，每一个心跳消息加 1，范围 0-255，如果此生命值不连续，表示心跳消息丢失，即通信不稳。
...
extern void MotorNotice(uint8_t busId, uint8_t nodeId, MW_CMD_ID cmdId);
extern void MotorSet(uint8_t busId, uint8_t can_id, uint8_t *data, uint8_t dataSize); 
 ...
 */
extern uint8_t MWRegisterMotor(MWMotorAccessInfo motor);
 ...
 */
extern void MWReceiver(uint8_t busId, uint32_t canId, uint8_t *data);
 ...
 * @note cmd_id: 0x002
 */
extern void MWEstop(uint8_t busId, uint8_t nodeId);
 ...
 * @note cmd_id: 0x003
 */
extern void MWGetMotorError(uint8_t busId, uint8_t nodeId, MW_ERROR_TYPE errorType);
 ...
 * @note cmd_id: 0x004
 */
extern void MWRxSdo(uint8_t busId, uint8_t nodeId, MW_ENDPOINT endpointData);
 ...
 * @note cmd_id: 0x006
 */
extern void MWSetAxisNodeID(uint8_t busId, uint8_t nodeId, uint8_t newNodeId, MWMotorAccessInfo *motorInfo);
 ...
 * @note cmd_id: 0x007
 */
extern void MWSetAxisState(uint8_t busId, uint8_t nodeId, MW_MOTER_STATE state);
 ...
 * @note cmd_id: 0x008
 */
extern void MWMitControl(uint8_t busId, uint8_t nodeId, MW_MIT_CTRL_INPUT *mit);
 ...
 * @note cmd_id: 0x009
 */
extern void MWGetEncoderEstimates(uint8_t busId, uint8_t nodeId);
 ...
 * @note cmd_id: 0x00B
 */
extern void MWSetControllerMode(uint8_t busId, uint8_t nodeId, MW_CONTROL_MODE ctrlMode, MW_INPUT_MODE inputMode);
 ...
 * @note cmd_id: 0x00C
 */
extern void MWPosControl(uint8_t busId, uint8_t nodeId, float inputPos, int16_t velFF, int16_t torqueFF);
 ...
 * @note cmd_id: 0x00D
 */
extern void MWVelControl(uint8_t busId, uint8_t nodeId, float inputVel, float torqueFF);
 ...
 * @note cmd_id: 0x00E
 */
extern void MWTorqueControl(uint8_t busId, uint8_t nodeId, float inputTorque);
 ...
 * @note cmd_id: 0x00F
 */
extern void MWSetLimits(uint8_t busId, uint8_t nodeId, float velLim, float currLim);
 ...
 * @note cmd_id: 0x010
 */
extern void MWStartAnticogging(uint8_t busId, uint8_t nodeId);
 ...
 * @note cmd_id: 0x011
 */
extern void MWSetTrajVelLimit(uint8_t busId, uint8_t nodeId, float velLim);
 ...
 * @note cmd_id: 0x012
 */
extern void MWSetTrajAccelLimits(uint8_t busId, uint8_t nodeId, float accLim, float decLim);
 ...
 * @note cmd_id: 0x013
 */
extern void MWSetTrajInertia(uint8_t busId, uint8_t nodeId, float inertia);
 ...
 * @note cmd_id: 0x016
 */
extern void MWReboot(uint8_t busId, uint8_t nodeId);
 ...
 * @note cmd_id: 0x018
 */
extern void MWClearErrors(uint8_t busId, uint8_t nodeId);
 ...
 * @note cmd_id: 0x01A
 */
extern void MWSetPosGain(uint8_t busId, uint8_t nodeId, float posGain);
 ...
 * @note cmd_id: 0x01B
 */
extern void MWSetVelGain(uint8_t busId, uint8_t nodeId, float velGain, float velIntGain);
 ...
 * @note cmd_id: 0x01E
 */
extern void MWDisableCAN(uint8_t busId, uint8_t nodeId);
 ...
 * @note cmd_id: 0x01F
 */
extern void MWSaveConfigeration(uint8_t busId, uint8_t nodeId);
